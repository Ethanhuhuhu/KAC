...
class Prompt(NormalNN):
    ...
    def init_optimizer(self):
        ...
        # if len(self.config['gpuid']) > 1:
        #     params_to_opt = list(self.model.module.prompt.parameters()) + list(self.model.module.last.parameters()) + list(self.model.module.last2.parameters())
        # else:
        #     params_to_opt = list(self.model.prompt.parameters()) + list(self.model.last.parameters()) + list(self.model.last2.parameters())
        print('*****************************************')
